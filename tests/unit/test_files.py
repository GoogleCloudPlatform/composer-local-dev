...
class TestFixFilePermissions:
    ...
    def test_fix_file_permissions_windows(self, mocked_is_windows, mocked_chmod):
    ...
    def test_fix_file_permissions_linux_sqlite(self, mocked_is_windows, mocked_chmod, tmp_path):
    ...
    @mock.patch("pathlib.Path.chmod")
    @mock.patch("composer_local_dev.utils.is_windows_os", return_value=False)
    def test_fix_file_permissions_linux_postgresql(self, mocked_is_windows, mocked_chmod, tmp_path):
