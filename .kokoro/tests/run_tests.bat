...
call %USERPROFILE%\.pyenv\pyenv-win\bin\pyenv install --skip-existing --register 3.11.9 3.12.4 3.13.1 3.14.0
call %USERPROFILE%\.pyenv\pyenv-win\bin\pyenv global 3.11.9 3.12.4 3.13.1 3.14.0
