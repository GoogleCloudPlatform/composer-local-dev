...
In the [docker container entrypoint file](https://github.com/GoogleCloudPlatform/composer-local-dev/compare/main...brightsidehealth:composer-local-dev:main#diff-fa4de1d9cdf3d34c17933b51af09305f89056befc664a1e5ffe6b17c8136fc750) we check for the presence of a `PRIVATE_INDEX_URLS` environment variable.
